...
class PurePursuit(Node):
    ...
    def __init__(self):
        ...
        self.lookahead = 1.0  # (meters) EXPERIMENT WITH VALUES (implement a changing lookahead distance based on curvature?) #
        self.speed = 4.0  # (meters/second) ADJUST AS NEEDED #
    ...
    def timer_callback(self):
        ...
        local_x = lookahead_pt[0]
        local_y = lookahead_pt[1]
